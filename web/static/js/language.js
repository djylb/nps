...
function showMsg(text, type = 'success', dur = 1500, cb) {
    ...
    w.style = 'position: fixed;z-index: 2147483647;width: 100%;height:100%;display:flex;flex-direction:column;justify-content:center;align-items:center';
    w.innerHTML =
      '<div id="loading">'
